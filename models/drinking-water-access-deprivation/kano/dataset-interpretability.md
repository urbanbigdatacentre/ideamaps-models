...
1. **Waterpoint offer** → whether waterpoints were working or broken, improved or unimproved, reliable, and safe to drink.
2. **Population demand** → the number of people from WorldPop estimates, distributed across the grid and adjusted for built-up density.

---

## Limitations and Assumptions

- Population data from WorldPop may not fully capture the most recent demographic changes or informal settlement growth.  
- Not all informal water vendors or small-scale distribution points were captured in the waterpoint dataset.  
- Service reliability was approximated where direct monitoring data were missing.  
- Travel time estimates rely on routing assumptions and do not always capture seasonal variability (e.g., flooding). 
- Only one community in Kano was able to validate this result, as the cutoff applied captured just one of the two communities.
...
-   [Waterpoint data](https://donatewater.ng/about/)
