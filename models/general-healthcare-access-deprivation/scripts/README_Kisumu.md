...
- `General_Healthcare_Access_Kisumu_V1.ipynb`: Main notebook to run the general healthcare access model.
- `General_Healthcare_Access_Kisumu_V1.py`: Python script version of the model.
- `Kisumu/data_inputs/`: Contains all required input data.
- `Kisumu/data_temp/`: Temporary files created during intermediate processing steps.
...
### 1. **Open the notebook:**  
   `General_Healthcare_Access_Kisumu_V1.ipynb`
...
Further methodological details can be found in the [dataset-interpretability](../Kisumu-v1/dataset-interpretability.md) documentation.

## 📎 Outputs

Review the outputs in the [output folder](../Kisumu-v1):
