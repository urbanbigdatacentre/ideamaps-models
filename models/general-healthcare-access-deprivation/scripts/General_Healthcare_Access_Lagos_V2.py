# %% [markdown]
# # Analysis of General Healthcare Access in Nigeria, Lagos
...
# ## Model Summary:
# 
# This notebook provides the means to generate a dataset that is described in the [model documentation](../Lagos-v2/dataset-interpretability.md).
# 
# ## Workflow Summary:
# 
...
# 
# 
# * Datasets of health facilities: Considering the Study area defined for Lagos, the selection of healthcare facilities relied on the intersection of the boundaries of our study area ([see the documentation about IDEAMAPS study areas](../../../docs/study-areas/README.md)).  
...
# %%
study_area = gpd.read_file(data_inputs + 'grid-boundary-lagos.gpkg')
...
# %% [markdown]
# ### Calculating the isochrones for 3.3km driving
...
# %% [markdown]
# ### Calculating the isochrones for 1km walking
