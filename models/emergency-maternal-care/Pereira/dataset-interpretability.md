...
| Deprivation level | Accessibility Score Range |
|-------------------|---------------------------|
| High (2)          | 0 ≤ score ≤ 0.007         |
| Medium (1)        | 0.007 < score ≤ 0.015     |
| Low (0)           | score > 0.015             |
...
| Deprivation level | Accessibility Score Range |
|-------------------|---------------------------|
| High (2)          | 0 < score ≤ 0.04360       |
| Medium (1)        | 0.04360 < score ≤ 0.07425 |
| Low (0)           | score > 0.07425           |
...
| Deprivation level | Accessibility Score Range          |
|-------------------|------------------------------------|
| High (2)          | 0 ≤ score ≤ 0.0000000001           |
| Medium (1)        | 0.0000000001 < score ≤ 0.0000087682|
| Low (0)           | score > 0.0000087682               |
...
| Deprivation level | Accessibility Score Range |
|-------------------|---------------------------|
| High (2)          | 0 ≤ score ≤ 0.00034       |
| Medium (1)        | 0.00034 < score ≤ 0.00778 |
| Low (0)           | score > 0.00778           |
