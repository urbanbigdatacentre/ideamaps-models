---
title: "ODMatrix-EmOC-Beira"
author: "Xingyi Du & Diego Pajarito"
...
origin_pts <- st_read('Beira/data-inputs/healthcare_facilities_beira_emoc.geojson')
dest_pts <- st_read('Beira/data-temp/grid_centroids.gpkg')
```
...
write.csv(results_matrix, "Abuja/data-temp/abujau_access.csv", row.names = FALSE)
